...
\hypertarget{intro}{%
\chapter{Introducción a la Economía Agraria}\label{intro}}
...
\hypertarget{comportamiento-del-consumidor}{%
\chapter{Comportamiento del Consumidor}\label{comportamiento-del-consumidor}}
